...
STREAM_LOGS = environ.get('STREAM_LOGS','-1001865164770')
SESSION = environ.get('SESSION','MissRozy')
CUSTOM_CAPTION = environ.get('CUSTOM_CAPTION')


class Config(object):
	API_ID = int(os.environ.get("API_ID", 28208784))
	...
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1001932263668")
	...
	LP_BTN_MAIN_CH_USRNM = os.environ.get("LP_BTN_MAIN_CH_USRNM","moviee_Hub_channel")
	LP_CHANNEL_USRNM = os.environ.get("LP_CHANNEL_USRNM","bot_Update_jishu")
	LPCH_ADMIN_USRMN = os.environ.get("LPCH_ADMIN_USRMN","PERSONAL_CHAT_ASSISTANT_BOT")
  ...
  # LP_CUSTOM_TEMPLATE= os.environ.get("LP_CUSTOM_TEMPLATE","{file_name} - example \n\n Please Upadate this template acording to you @LazyDeveloperr ")
	...
	AUTO_DELETE_TIME = int(os.environ.get('AUTO_DELETE_TIME', 1440))
...
🧑🏻‍💻 **DΞVΞLФPΞЯ:** [ᴊɪꜱʜᴜ ʙᴀʙᴀ](https://t.me/PERSONAL_CHAT_ASSISTANT_BOT)

👥 **šupp⊕r† gr⊕up:** [SupP⊕ЯΓ](https://t.me/MOVIES_REQUEST_NOW_2_0)

📢 **U͢p͢d͢a͢t͢e͢s͢ C͢h͢a͢n͢n͢e͢l͢:** [U͢p͢d͢a͢t͢e͢s͢](https://t.me/bot_Update_jishu)
"""
	ABOUT_DEV_TEXT = f"""
🧑🏻‍💻 <a href='https://t.me/PERSONAL_CHAT_ASSISTANT_BOT'>**ミ★- ᴊɪꜱʜᴜ ʙᴀʙᴀ -★彡** </a>

<a href=''https://t.me/PERSONAL_CHAT_ASSISTANT_BOT>ᴊɪꜱʜᴜ</a> ɪꜱ ꜱᴜᴘᴇʀ ɴᴏᴏʙ 😎. ᴊᴜꜱᴛ ʟᴇᴀʀɴɪɴɢ ꜰʀᴏᴍ ᴏꜰꜰɪᴄɪᴀʟ ᴅᴏᴄꜱ. ᴘʟᴇᴀꜱᴇ ᴅᴏɴᴀᴛᴇ ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴘᴇʀ ꜰᴏʀ ᴋᴇᴇᴘɪɴɢ ᴛʜᴇ ꜱᴇʀᴠɪᴄᴇ ᴀʟɪᴠᴇ.
ᴀʟꜱᴏ ʀᴇᴍᴇᴍʙᴇʀ ᴛʜᴀᴛ ᴅᴇᴠᴇʟᴏᴘᴇʀ ᴡɪʟʟ ᴅᴇʟᴇᴛᴇ ᴀᴅᴜʟᴛ ᴄᴏɴᴛᴇɴᴛꜱ ꜰʀᴏᴍ ᴅᴀᴛᴀʙᴀꜱᴇ. ꜱᴏ ʙᴇᴛᴛᴇʀ ᴅᴏɴ'ᴛ ꜱᴛᴏʀᴇ ᴛʜᴏꜱᴇ ᴋɪɴᴅ ᴏꜰ ᴛʜɪɴɢꜱ.
[𝐃𝐨𝐧𝐚𝐭𝐞 𝐧𝐨𝐰](https://t.me/PERSONAL_CHAT_ASSISTANT_BOT) (𝐃𝐨𝐧𝐚𝐭𝐞)
"""
	LAZY_HOME_TEXT = """
